...
const dict = {
  en: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Yearly",    price: "$1",    per: "/mo", desc: "Billed $12/yr",         feats: ["All 20+ locations", "Proprietary dynamic encryption", "Up to 8 devices simultaneously", "24/7 support", "Cancel anytime"] },
        { name: "2-Year",    price: "$0.88", per: "/mo", desc: "Billed $21.00/2 yrs",   feats: ["All 20+ locations", "Proprietary dynamic encryption", "Up to 8 devices simultaneously", "24/7 support", "Cancel anytime"] },
        { name: "Half-Year", price: "$1.50", per: "/mo", desc: "Billed $9.00/6 mos",    feats: ["All 20+ locations", "Proprietary dynamic encryption", "Up to 8 devices simultaneously", "24/7 support", "Cancel anytime"] },
        { name: "Monthly",   price: "$3",    per: "/mo", desc: "Billed monthly",         feats: ["All 20+ locations", "Proprietary dynamic encryption", "Up to 8 devices simultaneously", "24/7 support", "Cancel anytime"] },
        { name: "Quarterly", price: "$1.67", per: "/mo", desc: "Billed $5.00/quarter",  feats: ["All 20+ locations", "Proprietary dynamic encryption", "Up to 8 devices simultaneously", "24/7 support", "Cancel anytime"] },
      ],
    },
    faq: {
      ...
      items: [
        ...
        { q: "How many devices can I connect?", a: "Up to 8 devices can be connected simultaneously." },
      ],
    },
    ...
    dash: {
      ...
      devDesc: "Each account supports up to 8 devices, each connectable to all nodes.",
  ...
  zh: {
    ...
    pricing: {
      ...
      plans: [
        { name: "年付",  price: "¥9",  per: "/月", desc: "按年付 ¥108",     feats: ["全部 20+ 节点", "自研内核，独创动态加密", "支持 8 台设备同时在线", "7×24 支持", "随时订阅，随时取消"] },
        { name: "两年",  price: "¥8",  per: "/月", desc: "按两年付 ¥192",   feats: ["全部 20+ 节点", "自研内核，独创动态加密", "支持 8 台设备同时在线", "7×24 支持", "随时订阅，随时取消"] },
        { name: "半年",  price: "¥11", per: "/月", desc: "按半年付 ¥66",    feats: ["全部 20+ 节点", "自研内核，独创动态加密", "支持 8 台设备同时在线", "7×24 支持", "随时订阅，随时取消"] },
        { name: "月付",  price: "¥24", per: "/月", desc: "按月付",           feats: ["全部 20+ 节点", "自研内核，独创动态加密", "支持 8 台设备同时在线", "7×24 支持", "随时订阅，随时取消"] },
        { name: "季付",  price: "¥13", per: "/月", desc: "按季付 ¥39",      feats: ["全部 20+ 节点", "自研内核，独创动态加密", "支持 8 台设备同时在线", "7×24 支持", "随时订阅，随时取消"] },
      ],
    },
    faq: {
      title: "常见问题",
    ...
    dash: {
      ...
      devDesc: "每个账号最多添加 8 台设备，每台设备均可接入所有节点。",
