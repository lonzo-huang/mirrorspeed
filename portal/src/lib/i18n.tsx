...
const dict = {
  en: {
    ...
    download: {
      ...
      appClientDesc: "Native WireGuard app — one-tap login, automatic global node selection.",
      official: "Official",
  ...
  zh: {
    ...
    download: {
      ...
      appClient: "镜速加速器 客户端",
      appClientDesc: "原生 WireGuard 客户端，一键登录，自动接入全球节点。",
      official: "官方",
      fastDownload: "高速下载",
      backupDownload: "备用下载",
      comingSoon: "即将支持",
  ...
  de: {
    ...
    download: {
      ...
      appClient: "MirrorSpeed Client",
      appClientDesc: "Native WireGuard-App — Ein-Tipp-Login, automatische globale Knotenauswahl.",
      official: "Offiziell",
  ...
  fr: {
    ...
    download: {
      ...
      appClientDesc: "Application WireGuard native — connexion en un tap, sélection automatique du nœud.",
      official: "Officiel",
  ...
  it: {
    ...
    download: {
      ...
      appClient: "Client MirrorSpeed",
      appClientDesc: "App WireGuard nativa — login in un tap, selezione automatica del nodo globale.",
      official: "Ufficiale",
  ...
  es: {
    ...
    download: {
      ...
      appClientDesc: "App WireGuard nativa — inicio de sesión en un toque, selección automática de nodo global.",
      official: "Oficial",
  ...
  uk: {
    ...
    download: {
      ...
      appClientDesc: "Нативний застосунок WireGuard — вхід одним торканням, автоматичний вибір вузла.",
      official: "Офіційний",
  ...
  ja: {
    ...
    download: {
      ...
      appClientDesc: "ネイティブWireGuardアプリ — ワンタップログイン、自動グローバルノード選択。",
      official: "公式",
