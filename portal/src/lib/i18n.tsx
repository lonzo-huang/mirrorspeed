...
const dict = {
  en: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Yearly",    price: "$1",    per: "/mo", desc: "Billed $12/yr",         feats: ["All 20+ locations", "WireGuard + WebSocket relay", "Unlimited devices", "24/7 support", "7-day refund"] },
        ...
        { name: "Monthly",   price: "$3",    per: "/mo", desc: "Billed monthly",         feats: ["All 20+ locations", "WireGuard + WebSocket relay", "Unlimited devices", "24/7 support"] },
  ...
  zh: {
    ...
    pricing: {
      ...
      plans: [
        { name: "年付",  price: "¥8",  per: "/月", desc: "按年付 ¥96",      feats: ["全部 20+ 节点", "WireGuard + WebSocket 中继", "不限设备数", "7x24 支持", "7天退款"] },
        { name: "两年",  price: "¥7",  per: "/月", desc: "按两年付 ¥168",   feats: ["包含年付全部权益", "独立 IP 选项", "隐身模式", "优先队列"] },
        { name: "月付",  price: "¥24", per: "/月", desc: "按月付",           feats: ["全部 20+ 节点", "WireGuard + WebSocket 中继", "不限设备数", "7x24 支持"] },
  ...
  de: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Jährlich",    price: "$1",    per: "/Mo.", desc: "$12/Jahr",         feats: ["Alle 20+ Standorte", "WireGuard + WebSocket-Relay", "Unbegrenzte Geräte", "24/7 Support", "7-Tage-Rückgabe"] },
        { name: "2 Jahre",     price: "$0.90", per: "/Mo.", desc: "$21.60/2 Jahre",   feats: ["Alles im Jahresplan", "Dedizierte IP", "Stealth-Modus", "Prioritäts-Queue"] },
        { name: "Monatlich",   price: "$3",    per: "/Mo.", desc: "Monatlich",         feats: ["Alle 20+ Standorte", "WireGuard + WebSocket-Relay", "Unbegrenzte Geräte", "24/7 Support"] },
  ...
  fr: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Annuel",      price: "$1",    per: "/mois", desc: "$12/an",           feats: ["Tous les 20+ emplacements", "WireGuard + relais WebSocket", "Appareils illimités", "Support 24/7", "Remboursement 7 jours"] },
        { name: "2 ans",       price: "$0,90", per: "/mois", desc: "$21,60/2 ans",     feats: ["Tout du plan annuel", "IP dédiée", "Mode furtif", "File prioritaire"] },
        { name: "Mensuel",     price: "$3",    per: "/mois", desc: "Mensuel",           feats: ["Tous les 20+ emplacements", "WireGuard + relais WebSocket", "Appareils illimités", "Support 24/7"] },
  ...
  it: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Annuale",     price: "$1",    per: "/mese", desc: "$12/anno",          feats: ["Tutti i 20+ luoghi", "WireGuard + relay WebSocket", "Dispositivi illimitati", "Supporto 24/7", "Rimborso 7 giorni"] },
        ...
        { name: "Mensile",     price: "$3",    per: "/mese", desc: "Mensile",            feats: ["Tutti i 20+ luoghi", "WireGuard + relay WebSocket", "Dispositivi illimitati", "Supporto 24/7"] },
  ...
  es: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Anual",      price: "$1",    per: "/mes", desc: "$12/año",           feats: ["Todos los 20+ lugares", "WireGuard + relay WebSocket", "Dispositivos ilimitados", "Soporte 24/7", "Reembolso 7 días"] },
        { name: "2 años",     price: "$0,90", per: "/mes", desc: "$21,60/2 años",     feats: ["Todo del plan anual", "IP dedicada", "Modo sigiloso", "Cola prioritaria"] },
        { name: "Mensual",    price: "$3",    per: "/mes", desc: "Mensual",            feats: ["Todos los 20+ lugares", "WireGuard + relay WebSocket", "Dispositivos ilimitados", "Soporte 24/7"] },
  ...
  uk: {
    ...
    pricing: {
      ...
      plans: [
        { name: "Річний",      price: "$1",    per: "/міс", desc: "$12/рік",          feats: ["Всі 20+ локацій", "WireGuard + WebSocket-реле", "Необмежено пристроїв", "Підтримка 24/7", "Повернення за 7 днів"] },
        { name: "2 роки",      price: "$0,90", per: "/міс", desc: "$21,60/2 роки",    feats: ["Все з річного плану", "Виділена IP", "Режим стелс", "Пріоритетна черга"] },
        { name: "Місячний",    price: "$3",    per: "/міс", desc: "Щомісяця",          feats: ["Всі 20+ локацій", "WireGuard + WebSocket-реле", "Необмежено пристроїв", "Підтримка 24/7"] },
  ...
  ja: {
    ...
    pricing: {
      ...
      plans: [
        { name: "年払い",     price: "$1",    per: "/月", desc: "$12/年",          feats: ["20以上の全拠点", "WireGuard + WebSocketリレー", "デバイス無制限", "24時間サポート", "7日間返金"] },
        { name: "2年払い",    price: "$0.90", per: "/月", desc: "$21.60/2年",      feats: ["年払いの全機能", "専用IPオプション", "ステルスモード", "優先キュー"] },
        { name: "月払い",     price: "$3",    per: "/月", desc: "月払い",           feats: ["20以上の全拠点", "WireGuard + WebSocketリレー", "デバイス無制限", "24時間サポート"] },
