...
const SECTIONS_EN = [
  ...
  { h: "8. Device Limits", p: "Your subscription allows up to 3 simultaneous device connections. Each device must be individually registered. Attempting to circumvent device limits is a violation of these Terms." },
...
const SECTIONS_ZH = [
  ...
  { h: "6. 退款政策", p: `所有付费方案均提供 7 天无理由退款保证。如需退款，请在首次购买后 7 天内联系 ${CONTACT}。后续计费周期或超过 7 天窗口后不提供退款。` },
  ...
  { h: "8. 设备限制", p: "您的订阅允许最多 3 台设备同时连接。每台设备必须单独注册。试图规避设备限制违反本条款。" },
